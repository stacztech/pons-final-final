...
export class CountryChickenComponent implements OnInit {
  products: CountryChickenProduct[] = [
    ...
    },
    {
      ...
      image: 'assets/images/cccch2.png',
      price1kg: 400,
      price500g: 200,
      quantity1kg: 0,
      quantity500g: 0
  ...
  hasSelectedWeight(product: CountryChickenProduct): boolean {
    return (product.quantity1kg || 0) > 0 || (product.quantity500g || 0) > 0;
  }

  isProductInCart(product: CountryChickenProduct): boolean {
  ...
  addToCart(product: CountryChickenProduct) {
  ...
  decreaseQuantity(product: CountryChickenProduct, weightType: '1kg' | '500g') {
